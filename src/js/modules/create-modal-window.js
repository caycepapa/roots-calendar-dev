...
export function open(date,meta,num){
    ...
    var addView = (date,meta,num) =>{
        eventDomContent += 
            "<div>" +
                "<p>"+date+"</p>" +
                "<input type='text' name='"+ meta +"["+num+"][event_name]' value=''>" +
                "<input type='text' name='"+ meta +"["+num+"][event_url]' value=''>" +
                "<input type='color' name='"+ meta +"["+num+"][event_color]' value=''>" +
                "<input type='submit' value='追加' name='save'>" + 
    ...
    var rewriteView = (date,meta,num) =>{
        eventDomContent += 
            "<div>" +
                "<p>"+date+"</p>" +
                "<input type='text' name='" + meta + "["+num+"][event_name]' value='"+ events_list_arry[num].event_name + "'>" +
                "<input type='text' name='" + meta + "["+num+"][event_url]' value='" + events_list_arry[num].event_url + "'>" +
                "<input type='color' name='" + meta + "["+num+"][event_color]' value='" + events_list_arry[num].event_color + "'>" +
                "<input type='submit' value='更新' name='save'>" + 
